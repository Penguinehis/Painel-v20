    ...
    <div id="invoice-template" class="card-body">
        ...
        <div id="invoice-company-details" class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <h1><?php echo $fatu['id']; ?></h1>
                <div class="invoice-details mt-2">
                    <h6>Dia do vencimento.</h6>
                    <p><?php echo $diav;?>/<?php echo $mesv;?>/<?php echo $anov;?></p>
        ...
        <div class="col-sm-12 text-center">
            ...
            <button type="button" onclick="window.location.href='home.php?page=faturasclientes/verfatura&id=<?php echo $fatu['id'];?>&act=1'" class="btn btn-primary"><i class="fad fa-download"></i> Confirmar</button>
            <button type="button" onclick="window.location.href='home.php?page=faturasclientes/verfatura&id=<?php echo $fatu['id'];?>&act=2'" class="btn btn-primary"><i class="fad fa-times-circle"></i> Cancelar</button>
        </div>
        ...
        <div class="col-sm-12 text-center">
            <?php }elseif($fatu['status']=='pago'){ ?>
                <h3 class="text-center text-success">Fatura Paga</h3>
            <?php }elseif($fatu['status']=='cancelado'){ ?>
                <h4 class="text-center text-danger">Fatura Cancelada</h4>
            <?php } ?>
        </div>
    </div>
</section>