                    ...
                    <div class="card">
                        <div class="box box-primary">
                            <ul class="list-group list-group-unbordered">
                                ...
                                <li class="list-group-item">
                                    <b>Dono:</b> <a class="pull-right"><?php echo $usuario_sistema['nome'];?></a>
                                </li>
                            </ul>
                    ...
                    <div class="card-body p-b-0">
                        ...
                        <ul class="nav nav-tabs customtab" role="tablist">
                            <?php if($usuario['tipo']=="revenda"){?>
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#dono" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Alterar Dono</span></a> </li>
                            <?php } ?>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#senha" role="tab"><span class="hidden-sm-up"><i class="ti-lock"></i></span> <span class="hidden-xs-down">Senha</span></a> </li>
                            <?php if($usuario['tipo']=="revenda"){?>
