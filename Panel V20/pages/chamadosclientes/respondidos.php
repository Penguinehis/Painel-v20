    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <p>Chamados respondido listado abaixo.</p>
                    <div class="col-12"><br>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                                                    ...
                                                    <div class="btn-group" role="group">
                                                        <button class="btn btn-default btn-success">Encerrar Chamado</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                                                    ...
                                                    <div class="btn-group" role="group">
                                                        <button class="btn btn-default btn-danger">Responder</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
