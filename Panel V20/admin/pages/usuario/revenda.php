    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title font-medium-2"><i class="fad fa-users text-primary font-large-1"></i> Revendedores</h1>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <p>Clientes revendedores !</p>
                    <div class="col-12"><br>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0 js-sort-table" id="painel" data-search="minhaPesquisa-lista">
                        <thead>
                        <tr>
                            <th>STATUS</th>
                            <th>NOME</th>
